...
exports.runWithConfig = function(config) {
    ...
    function nextSuite() {
        ...
        read(baseurl + suite, function(err, data) {
            ...
            parseTests(testqueue, {}, nextSuite);
        }); 
    }
    ...
    function parseTests(testqueue, testcases, nextSuiteCallback) {
        ...
        if(testqueue.length === 0) return prepareAndExecuteTests(testcases, nextSuiteCallback);
    ...
    function executeCommand(commands, nextTestCallback, nextSuiteCallback) {
        ...
        // and jump to the next selenese command when done.
                    executeCommand(commands, nextTestCallback, nextSuiteCallback);
                });
            });
            return;
